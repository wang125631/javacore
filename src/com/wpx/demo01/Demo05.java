 ...
 * 变量就是一个存储数据的容器。
 * 
 * 容器具备什么特点： 1. 容量(大小)。 2. 存储一定格式的数据。 3. 名字.
 * 
 * 声明（定义）一个变量的格式：
 * 
 * 容量 变量名字 = 数据。
 ...
 * 
 * 在java中 的数据类型主要有两种数据类型 基本数据类型
 * 
 * 引用数据类型
 * 
 * java中的八种基本数据类型： 整数的数据类型： byte(字节) 8位（bit） 2^8 = 256 -128~127 short(短整型) 16bit
 * 2^16 = 65536 int(整型) 32bit long(长整型) 64bit 2^64 =
 * 
 ...
 * 
 * 
 * 八种基本数据类型： 整数：byte short int long 小数： float double 布尔： boolean 字符： char
 * 
...
public class Demo05 {
	...
	public static void main(String[] args) {
		...
		// 大类型转小类型以下是非必要的
		byte age = 10;
		System.out.println((long) ((int) ((short) age)));
		float f = 3.14f;
		 ...
		 * 
		 * 数据类型转换要注意的细节： 1. 凡是byte、short 、 char数据类型数据在运算的时候都会自动转换成int类型的数据再运算。 2.
